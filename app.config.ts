...
export default ({ config }: ConfigContext): ExpoConfig => ({
  ...
  extra: {
    ...
    EXPO_PUBLIC_SUPABASE_ANON_KEY: process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imx4YWpucm9ma2dwd2Rwb2RqdmttIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTQyNTUzODQsImV4cCI6MjA2OTgzMTM4NH0.26BHNOyaILt3lzPdcfs-zSBA-WKbORZEJuMQLnOkw8',
